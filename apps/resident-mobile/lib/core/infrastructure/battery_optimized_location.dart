...
class BatteryOptimizedLocationService {
  /**
   * Section 12: Ultra-low-battery emergency mode.
   * Dynamically degrades GPS frequency based on battery state.
   */
  Stream<Position> getEmergencyLocationStream(int batteryPercentage) {
  ...
  double deviceHealthScore({
    ...
    final score = (batteryScore * 0.4) + (signalQuality.clamp(0, 1) * 0.4) + (gpsScore * 0.2) - saverPenalty;
