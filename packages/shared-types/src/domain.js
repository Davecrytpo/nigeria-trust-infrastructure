...
export const PILOT_NEIGHBORHOOD = {
  ...
  city: 'Lagos',
  state: 'Lagos',
  coverageNote: 'Pilot coverage is currently limited to the Tejuosho, Sabo, and Commercial Avenue corridor.'
};
...
export function getStatus(id) {
  return INCIDENT_STATUSES.find((item) => item.id === id) ?? INCIDENT_STATUSES[0];
}
